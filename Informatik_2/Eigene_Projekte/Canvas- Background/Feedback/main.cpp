...
// CM: Der this->Pointer ist eigentlich nur bei Sichtbarkeitsproblemen von Variablen notwendig (z.B. Parameter einer Methode heißt wie Datenelement der Klasse). Typischerweise wird this-> weggelassen.
// Wie deklariere ich die Array Länge, wenn ich die Größe des Hintergrunds übergeben übergeben möchte?
// CM: Dann müssen Sie mit dynamischer Speicherplatzverwaltung arbeiten. (kommentiere ich noch in background.h)
...
// CM: Hatten Sie leere Klammern nach dem pictureTwo, also "Background pictureTwo();"? Dann wird das nämlich als lokaler Funktionsprototyp in main interpretiert.
